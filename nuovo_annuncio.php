                                ...
                                <div class="carousel-inner">
                                    <?php for ($i = 1; $i <= 6; $i++) { ?>
                                        <div class="carousel-item<?php if ($i === 1) echo ' active'; ?>">
                                            <div class="image-preview" id="preview<?= $i ?>" onclick="document.getElementById('foto<?= $i ?>').click();">
        ...
        function showPreview(previewId, input) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    imageNumber.style.display = "none"; // Ocultar el número cuando se muestra la imagen
                };

                reader.readAsDataURL(input.files[0]);
            } else {
                preview.style.backgroundImage = "none";
                imageNumber.style.display = "block"; // Mostrar el número si no se selecciona ninguna imagen
            }
        }
